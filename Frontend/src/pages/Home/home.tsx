      ...
      <main className="mx-auto flex max-w-7xl flex-col gap-20 px-4 py-20 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="mt-10 grid gap-8 md:grid-cols-2">
            {content.allEvents.filter(e => e.featured).slice(0, 2).map((event) => (
        ...
        >
          ...
          <GalleryCarousel photos={content.featuredGalleryPhotos} fallbackHighlights={content.galleryHighlights} />
        </motion.section>
        ...
        >
          ...
          <div className="mt-10 grid gap-6 md:grid-cols-3">
            {content.executiveMembers
              .filter(member => ["President", "General Secretary", "Vice President"].includes(member.position))
              .map((member) => (
